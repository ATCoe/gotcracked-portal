-- Checkout is an authoritative RPC and must explicitly enter the controlled
-- repair-status transition context before moving a paid repair to Sale Complete.
...
begin
  ...
  -- This RPC is the controlled checkout boundary. The repair status trigger rejects
  -- direct browser updates unless this transaction-local flag is present.
