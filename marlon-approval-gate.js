(()=>{
  ...
  function ensureStyle(){
    ...
    const s=document.createElement('style');s.id='gc-marlon-approval-style';s.textContent=`
      ...
      .gc-maintenance-approval{border-color:rgba(72,158,210,.54)!important;border-left:4px solid #4fc3f7!important;background:linear-gradient(135deg,rgba(12,36,57,.98),rgba(16,50,73,.96))!important;color:#e9f6ff!important;box-shadow:0 12px 30px rgba(3,18,31,.24)!important}
      .gc-maintenance-approval .gc-diagnostic-icon{background:rgba(79,195,247,.18)!important;color:#9fe5ff!important;border:1px solid rgba(79,195,247,.42)!important}.gc-maintenance-approval .gc-diagnostic-copy strong{color:#f1f9ff!important;font-weight:900!important}.gc-maintenance-approval .gc-diagnostic-copy p{color:#c6e7f6!important;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.gc-maintenance-approval .gc-diagnostic-copy small{color:#8fc4da!important}
      .gc-maintenance-approval .gc-diagnostic-actions{gap:8px;flex-wrap:wrap}.gc-maintenance-approval .gc-diagnostic-actions button{min-height:32px;padding:0 11px;border-radius:8px;text-decoration:none!important;font-weight:850}.gc-maintenance-review{background:rgba(79,195,247,.14)!important;color:#c6efff!important;border:1px solid rgba(79,195,247,.5)!important}
      .topbar .top-actions .gc-maintenance-approval{display:block!important;width:auto!important;padding:0!important;border:0!important;border-left:0!important;background:transparent!important;box-shadow:none!important;pointer-events:auto!important}.topbar .top-actions .gc-maintenance-approval .gc-diagnostic-icon,.topbar .top-actions .gc-maintenance-approval .gc-diagnostic-copy>strong,.topbar .top-actions .gc-maintenance-approval .gc-diagnostic-copy>p,.topbar .top-actions .gc-maintenance-approval .gc-diagnostic-copy>small{display:none!important}.topbar .top-actions .gc-maintenance-approval .gc-diagnostic-actions{margin:0!important}.topbar .top-actions .gc-maintenance-review{min-height:34px!important;padding:0 10px!important;white-space:nowrap!important;font-size:.7rem!important;background:rgba(79,195,247,.12)!important;color:#d4f3ff!important;border-color:rgba(79,195,247,.44)!important}
      @media(max-width:750px){.topbar .top-actions .gc-maintenance-review{max-width:88px!important;overflow:hidden!important;text-overflow:ellipsis!important}}
